  ...
  return (
    <footer className="bg-gray-900 text-white pt-10 pb-5">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h2 className="text-2xl font-bold text-green-500 mb-4">Kisan E-Commerce</h2>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm italic">Address: Bengaluru, India</p>
          <p className="text-gray-400 text-sm">Email: support@bighaat.com</p>
        </div>
      </div>
