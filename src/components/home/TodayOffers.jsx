...
// FIXED: Path changed from "../context/CartContext" to "../../context/CartContext"
...
const TodayOffers = () => {
    ...
    image: "https://m.media-amazon.com/images/I/61DJ2qxXlFL._SX300_SY300_QL70_FMwebp_.jpg",
    category: "Irrigation",
    badge: "40% OFF"
},
        {
                    ...
                    {offerProducts.map((product) => (
                        <div key={product.id} className="bg-white rounded-3xl p-3 border border-orange-100 flex flex-col group hover:shadow-2xl transition-all duration-300">
                            ...
                            <button 
                                ...
                                className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg text-sm font-semibold transition-all duration-300 active:scale-95"
                            >
                                Add to Cart
                            </button>
                        </div>
